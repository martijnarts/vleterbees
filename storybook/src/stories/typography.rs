...
pub const TYPOGRAPHY_STORY: Story = Story {
    name: "Typography",
    description: "Showcasing different typography elements.",
    component: &typography_story,
};

fn typography_story() -> View {
    view! {
        <Card>
            <CardContent class="pt-6">
                ...
                <P>
                    ...
                    <a href="#" class="font-medium text-primary underline underline-offset-4">
                        "a brilliant plan"
                    </a> ": he would tax the jokes in the kingdom."
                </P>
                <Blockquote>
